...
const Reviews = () => {
  return (
    <div className="mt-5 md:mt-40 md:mx-20 lg:mx-40 flex items-center justify-center flex-col">
      ...
      <div className="mt-7 w-[70%] xl:w-[50%] text-xs md:text-xl text-gray1">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</div>
