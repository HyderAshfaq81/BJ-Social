  ...
  return (
    <div className='flex flex-col items-center justify-between w-full h-screen'>
      <div className={`flex flex-col items-center ${loaded ? 'animated' : ''} mt-10`}>
        ...
        />
        <p className='text-gray1 text-xl font-semibold mt-3'>
          A safe space for serious singles who value and want real relationships
        </p>
        <div className='flex items-center justify-center gap-5'>
        <div className="text-white bg-[#FF7294] w-[200px] h-[40px] flex items-center justify-center rounded-[20px] mt-10 cursor-pointer" onClick={() => navigate('login')}>Get Started</div>
        <div className="text-white bg-[#FF7294] w-[200px] h-[40px] flex items-center justify-center rounded-[20px] mt-10 cursor-pointer" onClick={() => navigate('/home')}>Home</div>
      </div>
      </div>
